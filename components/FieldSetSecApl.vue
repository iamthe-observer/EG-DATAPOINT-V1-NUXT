				...
				<div class="flex gap-4 col-span-10 pl-6 justify-center">
					...
					<div class="form-control w-full">
						...
						<div class="indicator w-full">
							<span
								:class="['transition-all indicator-start duration-300 ease-in pointer-events-none indicator-item badge-sm badge bg-red-400 border-transparent drop-shadow-xl', vuelidate_err == false && !applicant.sdob ? 'opacity-100' : 'opacity-0']"></span>
