	...
	<div class="flex flex-col p-5 gap-10">
		...
		<div class="flex gap-4">
			...
			<div class="grid grid-cols-3 gap-2 w-full">
				<AplInfoCardDate :heading="`Date of Birth`" :date="new Date(apl.pdob!)" :name_type="'pdob'" />
				...
				<AplInfoCardDate @update:model-value="logger"
					:date="apl.passport_ex ? new Date(apl.passport_ex!) : undefined" :name_type="'passport_ex'"
		...
		<div v-if="apl.pmarital_status == 'MARRIED'" class="flex gap-4">
			...
			<div class="grid grid-cols-3 gap-2 w-full h-fit">
				...
				<AplInfoCardDate @update:model-value="logger" :date="new Date(apl.sdob!)" :name_type="'sdob'"
