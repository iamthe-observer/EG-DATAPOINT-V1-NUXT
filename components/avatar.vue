	...
	<section
		...
		<div class="avatar">
			<div
				...
				<svg class="drop-shadow-lg" v-if="!role" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					<path fill="#fff"
				...
				<svg class="drop-shadow-lg" v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<div v-if="username"
			:class="['__username px-1 font-bold text-purple-300', is_mobile ? 'text-lg font-bold' : 'text-sm']">{{
				username ||
				'User'
			}}
		</div>
