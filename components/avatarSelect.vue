<template>
	<div
		:class="`relative aspect-square w-full dark:bg-neutral-300 bg-neutral-600 rounded-lg ${classer ? classer : ''}`">
		...
		<div class="absolute inset-1 rounded-md dark:bg-neutral-200 bg-neutral-700 grid place-items-center" v-else><img
				:src="src ? src : ''" :alt="alt" class="w-full h-full rounded-md object-cover overflow-hidden"></div>
	</div>
</template>
